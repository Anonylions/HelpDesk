...
$page_title = "HelpDesk"; //Page title that will appear in the browser tab.
$website_url = "https://helpdesk11.herokuapp.com/"; //link to the website where this is hosted on. Please add http:// if applicable. Please use a forward-slash (/) at the end of the url like in the example.
